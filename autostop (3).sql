...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 24 2023 г., 07:14
...
INSERT INTO `order` (`id`, `detname`, `modelid`, `price`, `userid`, `date_time`) VALUES
(1, 1, 1, '1300.00', 1, '2023-01-02 06:17:39'),
(2, 1, 2, '400.00', 2, '2023-01-18 06:17:39');
...
ALTER TABLE `order`
  ...
  ADD KEY `detinfo` (`detname`) USING BTREE,
  ADD KEY `detid` (`detname`),
...
--
ALTER TABLE `models`
  MODIFY `modelid` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `order_ibfk_1` FOREIGN KEY (`detname`) REFERENCES `detail` (`id`),
  ...
  ADD CONSTRAINT `order_ibfk_4` FOREIGN KEY (`modelid`) REFERENCES `detail` (`detmodelid`) ON DELETE CASCADE;
COMMIT;
